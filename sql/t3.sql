...
SELECT SUM((1-DISCOUNT)*NET_PRICE*QUANTITY*VAT) FROM ( 
(SELECT INVOICE_ID FROM INVOICES 
WHERE INVOICE_DATE < DATE '2016-01-01') i INNER JOIN INVOCIE_ITEMS ii ON i.INVOICE_ID = ii.INVOICE_ID 
) INNER JOIN  
...
INSERT INTO Timers(timer_id,querry_id,total_time) VALUES(TIMER_SEQ.nextval,3, (dbms_utility.get_time-:n)/100);
alter system flush buffer_cache;
alter system flush shared_pool;
