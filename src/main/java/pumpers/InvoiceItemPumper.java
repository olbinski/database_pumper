...
public class InvoiceItemPumper extends AbstractPumper {
    @Override
    protected List<CsvSerializable> pump() {


        try (ProgressBar pb = new ProgressBar("InvoiceItem generator", PumperConfig.INVOICE_AMOUNT)) { // name, initial max
